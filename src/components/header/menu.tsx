          ...
          >
            <ol className="bg-base bg-op-70! backdrop-blur-md p-2 rounded-lg color-base text-base">
              ...
              <li className="flex gap-2 items-center">
                <a
                  href="https://github.com/Kayparavel/newsnow-kayparavel"
                >
                  <img
                    alt="GitHub stars badge"
                    src="https://img.shields.io/github/stars/Kayparavel/newsnow-kayparavel?logo=github&style=flat&labelColor=%235e3c40&color=%23614447"
                  />
                </a>
                <a
                  href="https://github.com/Kayparavel/newsnow-kayparavel/fork"
                >
                  <img
                    alt="GitHub forks badge"
                    src="https://img.shields.io/github/forks/Kayparavel/newsnow-kayparavel?logo=github&style=flat&labelColor=%235e3c40&color=%23614447"
                  />
                </a>
              </li>
            </ol>
